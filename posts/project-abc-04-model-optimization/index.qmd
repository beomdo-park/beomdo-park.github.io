...
tags: ["하이퍼파라미터", "Optuna", "모델최적화", "오토인코더"]
page-layout: full
image: image.png
freeze: true
---
...
[Week3 포스트](/posts/project-abc-03-cnn-baseline/)에서 기본적인 CNN 오토인코더 모델을 구현했습니다. 이번 포스트는 해당 모델을 기반으로 성능을 개선하는 과정에 초점을 맞춥니다.
:::
...
![지난주 탐지 결과 그래프](/posts/project-abc-03-cnn-baseline/index_files/figure-html/visualization-output-1.png)

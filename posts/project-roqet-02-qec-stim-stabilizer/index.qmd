...
```{python}
#| label: stim-detslice
#| fig-cap: "거리 d=3 rotated surface code의 안정자 배치 (Stim 자체 생성). 빨강=X-stabilizer, 파랑=Z-stabilizer."
from IPython.display import SVG
SVG(str(circuit.diagram("detslice-svg")))
```
...
```{python}
#| label: stim-matchgraph
#| fig-cap: "거리 d=3, 라운드 3인 메모리 회로의 detector match graph. 노드=detector, 엣지=물리적 오류 메커니즘."
from IPython.display import SVG
SVG(str(circuit.diagram("matchgraph-svg")))
```
